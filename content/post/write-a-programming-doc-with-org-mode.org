...
[[https://github.com/gpoore/minted][minted]] 宏包和
[[http://pygments.org/][pygments]] 这个高亮的工具并且设置 Emacs 让 Org-mode 输出
LaTeX 的时候把这个包带上：
...
这个时候就需要手动删除 ~_minted-test~ 这个文件夹，然后再运行即可。具体可以查看
~minted~ 的 [[https://github.com/gpoore/minted/issues/92][issue]]。
#+END_QUOTE
